...
firepad.FirebaseAdapter = (function (global) {
  ...
  FirebaseAdapter.prototype.sendOperation = function (operation, callback) {
    ...
    $(document).ready(function () {
      ...
      var obj = JSON.stringify(operation)
      $.ajax({
          type: "POST",
          // upload flask to heroku and update url
          url: "https://collab-edit-426.web.app/encrypt",
  ...
  FirebaseAdapter.prototype.parseRevision_ = function(data) {
    ...
    try {
      $(document).ready(function () {
        ...
        var obj = JSON.stringify(data.o)
        console.log(obj.o)
        $.ajax({
            type: "POST",
            url: "https://collab-edit-426.web.app/decrypt",
            contentType: "application/json",
            data: obj,
            success: function (response) {
                decryptedjson=response
